; WindowSwitcher Installer with .NET 8 Runtime Auto-Download
; Author: Hadi Cahyadi <cumulus13@gmail.com>

!define APP_NAME "WindowSwitcher"
!define APP_VERSION "1.0.5"
!define APP_PUBLISHER "Hadi Cahyadi"
!define APP_URL "https://github.com/cumulus13/WindowSwitcher"
...
Section "Install" SecInstall
  ...
  CreateShortcut "$SMPROGRAMS\${APP_PUBLISHER}\${APP_NAME}.lnk" "$INSTDIR\WindowSwitcher.exe"
  CreateShortcut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\WindowSwitcher.exe"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APP_NAME}" "DisplayIcon" "$INSTDIR\WindowSwitcher.exe"
...
Section "Uninstall"
  ...
  nsExec::Exec 'taskkill /F /IM WindowSwitcher.exe'
  Sleep 500
  
  ; Remove files
  Delete "$INSTDIR\WindowSwitcher.exe"
  Delete "$INSTDIR\*.dll"
  Delete "$INSTDIR\*.json"
