...
:: dotnet publish "c:\PROJECTS\dotnet\WindowSwitcher\WindowSwitcher.csproj" -c Release -r win-x64 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true
